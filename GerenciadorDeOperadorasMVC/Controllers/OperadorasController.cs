...
namespace GerenciadorDeOperadorasMVC.Controllers
{
    public class OperadorasController : Controller
    {
        ...
        public OperadorasController(GerenciadorDeOperadorasMVCContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Operadora.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var operadora = await _context.Operadora
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Operadora operadora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Operadora operadora)
        {
            if (id != operadora.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!OperadoraExists(operadora.Id))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Operadora.Any(e => e.Id == id);
        }
    }
}
